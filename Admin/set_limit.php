...
<head>
	...
	<link rel="stylesheet" type="text/css" href="set_limit_style.css">   
              ...
              <nav id="navbar" class="navbar" style="margin-top: 0%;">
                <ul style="padding-top: 20px;">
                  ...
                  <ul style="margin-left: 72%;">
                    ...
                    <li><a class="nav-link scrollto active" href="../Admin/set_limit.php">Set Limit</a></li>
	...
	<div class="d-flex justify-content-center h-100">      
		...
		<div class="cardnewcontact">
			...
			<div class="card-header">
				<h3 class="addcontact">Set Limit</h3>				
			</div>
			...
			<div class="card-body" >
				<form method="post" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="amt" name="amt" class="form-control" style="width: 300px;">
                    </div> 
