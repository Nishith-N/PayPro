...
<head>
	...
	<link rel="stylesheet" type="text/css" href="lock_users_style.css">   
              ...
              <nav id="navbar" class="navbar" style="margin-top: 0%;">
                <ul style="padding-top: 20px;">
                  ...
                  <ul style="margin-left: 72%;">
                    ...
                    <li><a class="nav-link scrollto active" href="../Admin/lock_users.php">Lock Users</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="d-flex justify-content-center h-100">      
		...
		<div class="cardnewcontact">
			...
			<div class="card-header">
				<h3 class="addcontact">Lock Users</h3>				
			</div>
			...
			<div class="card-body" >
				<form method="post" action="#">
					...
					<div class="form-group">
						<input type="submit" value="Lock" class="btn float-right add_contact_btn" id="submit_btn" name="submit_btn">
					</div>
