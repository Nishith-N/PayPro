    ...
    header("Location:../Login/login.php");
		...
		$amount=0;
          ...
          $sql="SELECT primary_card FROM user_details WHERE phone='".$username."' OR email='".$username."'";
				...
				$result=mysqli_query($db,$sql);
                $sql="UPDATE bank_details SET amount='".$addamount."' WHERE phone='".$username."' AND card_number='".$cardnum."'";
				$result=mysqli_query($db,$sql);
...
<head>
  ...
  <link href="remove_money_style.css" rel="stylesheet">
		...
		<div class="cardregister" style="margin-top: 180px">
			...
			<div class="card-body">
				<form method="post" action="#">
					...
					<div class="form-group">
						<input type="submit" value="Remove" class="btn float-right login_btn" name="submit_btn" id="submit_btn">
					</div>
				</form>
			</div>
		</div>
