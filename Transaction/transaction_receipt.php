		...
		<div class="cardnewcontact">
			...
			<div class="card-body" >
				<table  style="width: 100%;border-spacing: 20px;color:black">
                    ...
                    <tr >
                        <td style="padding-left: 20px;padding-bottom: 3px;">Name:</td>
                    </tr>
                    <tr >
                        <td style="padding-left: 20px;padding-bottom: 3px;">Email:</td>
                    </tr>
                    <tr >
                        <td style="padding-left: 20px;padding-bottom: 9px;">Phone Number:</td>
                    </tr>
                    <tr>
                    ...
                    <tr >
                        <td style="padding-left: 20px;padding-bottom: 20px;">Phone Number:</td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 3px;">Date:</td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 20px;">Transaction ID:</td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 3px;">Amount:</td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 3px;">Reason:</td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 3px;">Coupons:</td>
                    </tr>
                </table>
			</div>
		</div>
